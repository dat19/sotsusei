...
# 11月末までの日程
  ...
  - 10/14
  - 10/21, 23
  - 10/28, <s>30 α版完成 / 試遊会</s>
  - 11/6
  - 11/11, 13
  - 11/18, 20 <s>Web公開候補版</s>
  - 11/25, 27 <s>仕上げ / Web公開</s>
  - 12/2, 4 α版完成 / 試遊会(でき次第) 
  - 12/9, 11 β版完成 / 試遊会
  - 12/16, 18 Web公開候補版 / ノベル打ち合わせ
  - 12/23, 25 仕上げ / Web公開
...
## Slackの利用
- いざという時のリモート対応と、卒業制作の成果物の確実な完成のため、残りの期間はSlack上で作業予定と成果物の報告を行う
  - 招待メールを送信する先のメールアドレスを [こちら](https://docs.google.com/forms/d/e/1FAIpQLSf6187LR9eL0gMsN3Ls6PzpyTjyHVBYc80brDxRnVnnKmLtyg/viewform?usp=sf_link) から登録してください
    - ログイン時に必要になります
    - プライベートで利用しているアドレスはなるべく避け、学校活動用にGmailアドレスなどを作成して、それを登録することを推奨します
- Slackでやること
  - 金曜日に、進捗と予定のチャンネルに以下を報告
    - その週の成果物を箇条書きで書く。また、スクリーンショットや手書きのものはスマホで撮影
...
- 卒業制作の作業、質疑応答
  - ローグライク
    - 各自の作業を統合 / タイトル > ゲーム > ゲームオーバー or リザルト > エンディングの流れ / ボスの仕様決め
- Flying in the sky
