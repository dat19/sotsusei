...
|ステップ|キャラクターCG|プログラム|
|-:|:-|:-|
|1|・フェーズ1に必要な仮グラフィックデータをなるべく早く作成<br>(おおよその色、大きさ、アニメの枚数を、絵自体はラフで構わないので早急に揃える)<br>・ポートフォリオに使うことを想定して、ゲームの素材を奇麗に仕上げる|・Unityのプロジェクトを作成して、チーム開発できるようにGitHub上で共有<br>・重要なシーンから、仮のグラフィックを表示できるような仕組みを作る|
